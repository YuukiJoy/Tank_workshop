...
public class EnemyMovement : MonoBehaviour
{
     ...
     {
          if (other.transform.TryGetComponent(out Destroyable d))
          {
               GameObject g = Instantiate(d.destroyEffect, other.transform.position + d.effectPosOffset, quaternion.identity);
               g.transform.localScale = d.effectSize;
